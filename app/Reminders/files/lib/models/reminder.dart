...
String reminderSectionTitle(ReminderSectionId sectionId) {
  switch (sectionId) {
    case ReminderSectionId.overdue:
      return 'Просрочено';
    case ReminderSectionId.today:
      return 'Сегодня';
    case ReminderSectionId.upcoming:
      return 'Позже';
    case ReminderSectionId.noDate:
      return 'Без срока';
    case ReminderSectionId.completed:
      return 'Выполнено';
  }
}
...
int normalizeGoal(int value) {
  ...
  if (value > dailyGoalDefault) {
    return dailyGoalDefault;
  }
