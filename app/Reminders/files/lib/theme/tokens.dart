...
class RemindersTokens {
  ...
  static final contentSubPrimary = hsl(210, 0.11, 0.15, 0.72);
  static final contentSecondary = hsl(210, 0.11, 0.15, 0.52);
  static final contentDisabled = hsl(210, 0.11, 0.15, 0.28);
  static final contentBorder = hsl(210, 0.11, 0.15, 0.12);
  static final contentBackground = hsl(210, 0.11, 0.15, 0.04);

  static final accentPrimary = hsl(213, 0.88, 0.56);
  static final accentSubPrimary = hsl(213, 0.88, 0.56, 0.72);
  static final accentSecondary = hsl(213, 0.88, 0.56, 0.52);
  static final accentDisabled = hsl(213, 0.88, 0.56, 0.28);
  static final accentBorder = hsl(213, 0.88, 0.56, 0.20);
  static final accentBackground = hsl(213, 0.88, 0.56, 0.04);
  static final accentSelection = hsl(213, 0.88, 0.56, 0.22);

  static final systemSuccessPrimary = hsl(163, 0.70, 0.47);
  static final systemSuccessBackground = hsl(163, 0.70, 0.47, 0.08);
  static final systemErrorPrimary = hsl(353, 0.88, 0.56);
  static final systemErrorBackground = hsl(353, 0.88, 0.56, 0.08);
  static final systemWarningPrimary = hsl(42, 0.89, 0.55);
  static final systemWarningBackground = hsl(42, 0.89, 0.55, 0.08);
