...
class ReminderModalLayer extends StatelessWidget {
    ...
    return BackdropFilter(
      ...
      child: DecoratedBox(
        ...
        child: Padding(
          ...
          child: Align(alignment: Alignment.bottomCenter, child: _buildSheet()),
        ),
      ),
    );
  }
  ...
  Widget _buildSheet() {
    switch (modal) {
      case RemindersModalPreview.goalSetup:
        return GoalSetupSheet(
          initialGoal: planGoal,
          initialSelectedDays: selectedDays,
          onSave: onSaveGoal,
        );
      case RemindersModalPreview.success:
        return CongratulationsSheet(
          completedCount: completedCount,
          planGoal: planGoal,
          onClose: onClose,
        );
      case RemindersModalPreview.createTask:
