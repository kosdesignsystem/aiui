...
class _GoalSetupSheetState extends State<GoalSetupSheet> {
  ...
  @override
  void didUpdateWidget(covariant GoalSetupSheet oldWidget) {
    super.didUpdateWidget(oldWidget);

    if (oldWidget.initialGoal != widget.initialGoal ||
        oldWidget.initialSelectedDays != widget.initialSelectedDays) {
      _draftGoal = normalizeGoal(widget.initialGoal);
      _selectedDays = List<int>.of(widget.initialSelectedDays);
    }
  }
...
IconData _listIcon(ReminderListId listId) {
  switch (listId) {
    case ReminderListId.work:
      return Icons.work_outline;
    case ReminderListId.home:
      return Icons.home_outlined;
    case ReminderListId.personal:
