...
class RemindersHeader extends StatelessWidget {
  const RemindersHeader({Key? key, required this.title, this.meta})
      : super(key: key);
...
class BottomActionBar extends StatelessWidget {
  const BottomActionBar({Key? key, required this.child}) : super(key: key);
                ...
                children: [
                  ...
                  if (widget.collapsible)
                    RoundIconButton(
                      ...
                      label:
                          _collapsed ? 'Развернуть список' : 'Свернуть список',
                      size: 32,
